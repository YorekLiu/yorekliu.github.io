...
![View的四个顶点以及MotionEvent的x、y、rawX、rawY]({{ basepath}}/assets/images/android/view的位置坐标.png)
{: .align-center}
...
![ViewGroup的事件传递规则]({{ basepath}}/assets/images/android/ViewGroup的事件传递规则.png)
...
![两种基本滑动冲突]({{ basepath}}/assets/images/android/两种基本滑动冲突.png)
